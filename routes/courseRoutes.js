...
courseRoutes.put("/update/:id", verifyToken ,  allowRoles("superadmin" , "modifier") ,updateCourse);
courseRoutes.patch("/category-update/:id", updateCategoryInfo);
courseRoutes.delete("/delete/:id" , verifyToken  , allowRoles("superadmin" , "modifier"), deleteCourse);

courseRoutes.post("/add-faq/:courseId", verifyToken , allowRoles("admin" , 'modifier' , "superadmin") , addFaqToCourse);
courseRoutes.get("/faqs/:courseId" , getCourseFaqs);
courseRoutes.put("/faqs/:courseId/:faqId", verifyToken , allowRoles("superadmin" , "modifier"), updateFaq);
courseRoutes.delete("/faqs/:courseId/:faqId", verifyToken , allowRoles("superadmin" , "modifier") , deleteFaq);
